<!-- CRYSTAL: Xi108:W3:A11:S35 | face=S | node=618 | depth=3 | phase=Mutable -->
<!-- METRO: Me -->
...
# Improvement Step 0120

## Improvement Signature

- `density` -> `atlas` -> `verify` -> `seed`
...
This step repairs a local weakness where `density` has not yet been fully carried through `atlas` into `verify` and `seed`.
