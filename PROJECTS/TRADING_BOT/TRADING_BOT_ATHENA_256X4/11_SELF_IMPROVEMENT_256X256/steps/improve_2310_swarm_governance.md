<!-- CRYSTAL: Xi108:W3:A5:S32 | face=S | node=500 | depth=3 | phase=Mutable -->
<!-- METRO: Me,Cc -->
...
# Improvement Step 2310

## Improvement Signature

- `swarm` -> `governance` -> `expand` -> `seed`
...
This step repairs a local weakness where `swarm` has not yet been fully carried through `governance` into `expand` and `seed`.
