<!-- CRYSTAL: Xi108:W3:A10:S32 | face=S | node=528 | depth=3 | phase=Mutable -->
<!-- METRO: Me,Cc -->
...
# Improvement Step 0321

## Improvement Signature

- `density` -> `governance` -> `verify` -> `relay`
...
This step repairs a local weakness where `density` has not yet been fully carried through `governance` into `verify` and `relay`.
