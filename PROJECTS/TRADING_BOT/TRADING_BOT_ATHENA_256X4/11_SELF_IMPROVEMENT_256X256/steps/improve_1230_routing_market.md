<!-- CRYSTAL: Xi108:W3:A4:S34 | face=S | node=563 | depth=3 | phase=Mutable -->
<!-- METRO: Me -->
...
# Improvement Step 1230

## Improvement Signature

- `routing` -> `market` -> `integrate` -> `seed`
...
This step repairs a local weakness where `routing` has not yet been fully carried through `market` into `integrate` and `seed`.
