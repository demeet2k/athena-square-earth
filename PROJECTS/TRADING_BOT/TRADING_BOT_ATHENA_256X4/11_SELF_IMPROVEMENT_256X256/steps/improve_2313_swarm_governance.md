<!-- CRYSTAL: Xi108:W3:A5:S34 | face=S | node=565 | depth=3 | phase=Mutable -->
<!-- METRO: Me,Cc -->
...
# Improvement Step 2313

## Improvement Signature

- `swarm` -> `governance` -> `expand` -> `renew`
...
This step repairs a local weakness where `swarm` has not yet been fully carried through `governance` into `expand` and `renew`.
