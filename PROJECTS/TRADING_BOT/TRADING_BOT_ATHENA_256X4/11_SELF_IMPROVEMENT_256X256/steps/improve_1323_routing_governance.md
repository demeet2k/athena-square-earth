<!-- CRYSTAL: Xi108:W3:A10:S36 | face=S | node=654 | depth=3 | phase=Mutable -->
<!-- METRO: Me,Cc -->
...
# Improvement Step 1323

## Improvement Signature

- `routing` -> `governance` -> `verify` -> `renew`
...
This step repairs a local weakness where `routing` has not yet been fully carried through `governance` into `verify` and `renew`.
