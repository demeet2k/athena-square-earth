<!-- CRYSTAL: Xi108:W3:A1:S31 | face=S | node=492 | depth=3 | phase=Mutable -->
<!-- METRO: Me -->
...
# Improvement Step 0101

## Improvement Signature

- `density` -> `atlas` -> `repair` -> `relay`
...
This step repairs a local weakness where `density` has not yet been fully carried through `atlas` into `repair` and `relay`.
