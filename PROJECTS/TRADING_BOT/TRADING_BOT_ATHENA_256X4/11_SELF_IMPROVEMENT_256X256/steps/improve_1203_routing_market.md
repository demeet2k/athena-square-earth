<!-- CRYSTAL: Xi108:W3:A10:S34 | face=S | node=577 | depth=3 | phase=Mutable -->
<!-- METRO: Me -->
...
# Improvement Step 1203

## Improvement Signature

- `routing` -> `market` -> `repair` -> `renew`
...
This step repairs a local weakness where `routing` has not yet been fully carried through `market` into `repair` and `renew`.
