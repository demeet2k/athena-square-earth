<!-- CRYSTAL: Xi108:W3:A10:S32 | face=S | node=524 | depth=3 | phase=Mutable -->
<!-- METRO: Me,Cc,△ -->
...
# Improvement Step 3311

## Improvement Signature

- `recursion` -> `governance` -> `expand` -> `relay`
...
This step repairs a local weakness where `recursion` has not yet been fully carried through `governance` into `expand` and `relay`.
