<!-- CRYSTAL: Xi108:W3:A1:S31 | face=S | node=467 | depth=3 | phase=Mutable -->
<!-- METRO: Me -->
...
Formal Exploder operating in `verify` mode exists to verify and bound while preserving the role's core bias.
