<!-- CRYSTAL: Xi108:W3:A5:S35 | face=S | node=596 | depth=3 | phase=Mutable -->
<!-- METRO: Me -->
...
Experimental Driver operating in `map` mode exists to map and abstract while preserving the role's core bias.
